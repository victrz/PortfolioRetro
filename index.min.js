...
;window.Modernizr = function (a, b, c) {
  function z(a) {
    ...
    var c;return "ontouchstart" in a || a.DocumentTouch && b instanceof DocumentTouch ? c = !0 : w(["@media (", m.join("touch-enabled),("), h, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function (a) {
      c = a.offsetTop === 9;
    }), c;
...
$(document).ready(function () {
	var currentYear = new Date().getFullYear(); // Get the four digit year (yyyy)
...
var Slider = function () {
	...
	transEndEventName = transEndEventNames[Modernizr.prefixed('transition')],
	    ...
	    updateNavImages = function updateNavImages() {
...
var indexer = __webpack_require__(2);
var slider = __webpack_require__(1);
var custom = __webpack_require__(0);
